 ...
 * and — for round-trips that return to this app (login) — optionally snapshots the converter work so it's
 * restored when we come back. Use `preserve: true` only for navigations that land back on v2x.tools.
 */
